  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      ...
      <Router>
        ...
        <ProfilePopup
          ref={profilePopupRef}
          username={profilePopupContent.username}
          src={`${address}/avatars/${profilePopupContent.id}.webp`}
        />
        <div
          className={`ImageOverlay ${imageOverlayShown ? "show" : "hide"}`}
          onClick={() => setImageOverlayShown(false)}
          onWheel={handleOverlayWheel}
        >
          <div
            className={`ImageOverlayContent ${imageOverlayShown ? "show" : "hide"}`}
          >
            <img
