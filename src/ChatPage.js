            ...
            <div class="popup" id="account-popup">
                ...
                <div class="popup-content">
                    <div class="scrollable-y">
                        <p style={{ fontSize: '3svh' }}>Account is required to use MIN. Please <a href='signup' style={{ color: '#4f7afbff' }}>create</a> one or <a href='login' style={{ color: '#4f7afbff' }}>login</a> into an existing one.</p>
